...
res_phi = And(q_notr, notp_r, notq_r_p, q_notp, r_notq)  
# Note: It's possible that the resolved set res_phi is over a smaller set of variables than phi.
# But since res_phi is constructed by discarding tautologies..... 
# v |= phi iff (v restricted to vars(res_phi)) |= res_phi.
